...
const CURATED_DATASET = {
    internships: [
        ['Google Summer Internship', 'Google', '2026-05-01', '2026-04-15'],
        ['Microsoft Internship', 'Microsoft', '2026-06-01', '2026-04-25'],
        ['Amazon SDE Internship', 'Amazon', '2026-05-20', '2026-04-20'],
        ['Goldman Sachs Internship', 'Goldman Sachs', '2026-06-10', '2026-05-01'],
        ['JPMorgan Internship', 'JPMorgan', '2026-06-15', '2026-05-05'],
        ['Adobe Internship', 'Adobe', '2026-05-25', '2026-04-18'],
        ['Flipkart Internship', 'Flipkart', '2026-06-05', '2026-04-28'],
        ['Walmart Global Tech Internship', 'Walmart', '2026-06-12', '2026-05-02'],
        ['Cisco Internship', 'Cisco', '2026-05-28', '2026-04-22'],
        ['IBM Internship', 'IBM', '2026-06-18', '2026-05-08'],
        ['Oracle Internship', 'Oracle', '2026-06-22', '2026-05-12'],
        ['Intel Internship', 'Intel', '2026-06-15', '2026-05-01'],
        ['Qualcomm Internship', 'Qualcomm', '2026-06-20', '2026-05-10'],
        ['Zoho Internship', 'Zoho', '2026-05-15', '2026-04-10'],
        ['Freshworks Internship', 'Freshworks', '2026-05-30', '2026-04-20'],
        ['Razorpay Internship', 'Razorpay', '2026-06-08', '2026-04-28'],
        ['Swiggy Internship', 'Swiggy', '2026-06-12', '2026-05-05'],
        ['Zomato Internship', 'Zomato', '2026-06-10', '2026-05-02'],
        ['Paytm Internship', 'Paytm', '2026-05-25', '2026-04-25'],
        ['PhonePe Internship', 'PhonePe', '2026-06-05', '2026-04-30']
    ],
    hackathons: [
        ['April Tech Hackathon', 'TechComm', '2026-04-15', '2026-04-05'],
        ['Google Cloud Hackathon', 'Google Cloud', '2026-04-18', '2026-04-10'],
        ['AWS Innovation Hackathon', 'AWS', '2026-04-20', '2026-04-12'],
        ['Smart India Hackathon', 'SIH', '2025-12-08', '2025-11-20'],
        ['Goldman Sachs Hackathon', 'Goldman Sachs', '2026-05-17', '2026-05-04'],
        ['Hack the Future (IIT Gandhinagar)', 'IIT Gandhinagar', '2026-04-25', '2026-04-15'],
        ['PSB FinTech Hackathon (IIT Hyderabad)', 'IIT Hyderabad', '2026-06-01', '2026-05-20'],
        ['HERE India Hackathon Women in Tech', 'HERE', '2025-10-10', '2025-10-05'],
        ['AI Hackathon with Meta Llama', 'Meta', '2026-04-22', '2026-04-12'],
        ['TCS HackQuest', 'TCS', '2025-09-15', '2025-08-25'],
        ['MSME Idea Hackathon', 'MSME', '2025-08-20', '2025-08-05'],
        ['KU Hackathon', 'KU', '2026-04-10', '2026-04-01'],
    ...
    events: [
        ['Techquest April Fest', 'Techquest', '2026-04-05', '2026-03-28'],
        ['April Innovation Summit', 'TechCommunity', '2026-04-12', '2026-04-01'],
        ['Spring Code Championship', 'CodeChampions', '2026-04-08', '2026-03-30'],
        ['Developer Conference 2026', 'DevCon', '2026-04-16', '2026-04-05'],
        ...
        ['Cognizance IIT Roorkee', 'IIT Roorkee', '2026-05-22', '2026-05-10'],
        ['Techkriti IIT Kanpur', 'IIT Kanpur', '2026-05-28', '2026-05-15'],
        ['Technex IIT BHU', 'IIT BHU', '2026-04-10', '2026-04-01'],
        ['Pragyan NIT Trichy', 'NIT Trichy', '2026-02-20', '2026-02-10'],
        ...
        ['Abhiyanta VNIT', 'VNIT', '2026-05-28', '2026-05-20'],
        ['Advitiya IIIT Allahabad', 'IIIT Allahabad', '2026-05-05', '2026-04-25'],
        ['Anwesha IIT Patna', 'IIT Patna', '2025-01-25', '2025-01-15'],
        ['Infinity IIT Indore', 'IIT Indore', '2025-01-18', '2025-01-10'],
        ['Daksh SSN College', 'SSN College', '2026-04-10', '2026-04-01'],
        ['Kurukshetra Anna University', 'Anna University', '2026-04-22', '2026-04-10'],
        ['INFINITUS SRM AP', 'SRM AP', '2026-04-30', '2026-04-20'],
